/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b8411f68f30f7449defce898577e2623)
// Runtime types generated with workerd@1.20250709.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare";
		WORKER_ENV: "staging" | "production";
		BETTER_AUTH_SECRET: string;
		DATABASE_URL: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_MAIL_SECRET: string;
		GOOGLE_CLIENT_SECRET: string;
		GOOGLE_MAIL_CLIENT_ID: string;
		GOOGLE_MAIL_REFRESH_TOKEN: string;
		SENDER_EMAIL: string;
		WEB_URL: string;
		CF_PAGES_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "WORKER_ENV" | "BETTER_AUTH_SECRET" | "DATABASE_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_MAIL_SECRET" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_MAIL_CLIENT_ID" | "GOOGLE_MAIL_REFRESH_TOKEN" | "SENDER_EMAIL" | "WEB_URL" | "CF_PAGES_URL">> {}
}
